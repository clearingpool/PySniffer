...
## ✨ Особенности
-  **Сниффинг в реальном времени:** Мгновенный захват входящих и исходящих пакетов.
-  **Умная фильтрация:** Фильтруйте трафик по протоколам (TCP, UDP, ICMP, HTTP и др.) в один клик.
-  **Современный GUI:** Интерфейс на базе PyQt5 с поддержкой масштабирования и высокой отзывчивостью.
-  **Детальный разбор:** Анализ структуры каждого пакета вплоть до полезной нагрузки (payload).
-  **Чистый Python:** Никаких сложных зависимостей на C, только чистый и понятный код.
